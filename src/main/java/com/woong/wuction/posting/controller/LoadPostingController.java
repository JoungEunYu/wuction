...
/**
 * Servlet implementation class LoadPostingController
 */
@WebServlet("/loadPosting.pr")
public class LoadPostingController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadPostingController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MainPagePosting> posts = new PostingServiceImpl().loadPostingList();
